...
-- Properties Policies
CREATE POLICY "Public Read Access Properties" ON public.properties
...
CREATE POLICY "Public Delete Properties" ON public.properties
...
CREATE POLICY "Public Read Broker Info" ON public.broker_info
  FOR SELECT USING (true);

CREATE POLICY "Public Manage Broker Info" ON public.broker_info
  FOR ALL USING (true);
